  ...
  <div class="login-container">
    ...
    <el-form class="login-form" :model="form" :rules="rules" ref="registerForm">
      ...
      <el-form-item prop="repasswd" label="确认密码">
        <el-input type="password"  v-model="form.repasswd" placeholder="请输入再次密码"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" class="register" @click.native.prevent="handRegister" round>注册</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
