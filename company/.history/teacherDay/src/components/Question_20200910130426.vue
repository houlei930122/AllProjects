  ...
  <div class="page">
    ...
    <div class="page-con">
      ...
      <div class="topic-wrap">
        <div class="topic-con">
          <div class="topic-msg" v-html="issueWord">
            {{issueWord}}
          </div>  
        </div>
    ...
    <transition name="fadedialog" >
      <div class="input-wrap" v-if="isComplete">
        <div class="input-content">
          <input v-model="name" ref="input" class="name" maxlength="6" type="text">
    ...
    <transition name="fadedialog" >
      <div class="share-wrap" v-if="isShare">
       ...
       <div class="hint-save">长按保存图片</div>
      </div>
    </transition>
...
export default {
  ...
  methods: {
    ...
    commit(){
      ...
      let bgArr = ['./static/err_bg1.jpg','./static/suc_bg1.jpg']
